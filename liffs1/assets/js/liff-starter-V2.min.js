...
function initContent(a) {
    ...
    c.appendChild(d),
    c.appendChild(e),
    g.insertBefore(c, g.childNodes[4])) : "sticker" == a || "stickerimage" == a ? (c.className = "form-label-group",
    c.id = "data",
    d.type = "text",
    d.id = "packageId",
    d.className = "form-control",
...
function sendLiffMessage() {
    var a = document.getElementById("type").value
      , b = new HttpClient
      , c = "Unknown"
      , d = "https://liff9.github.io/liffs1/assets/image/ms-icon-310x310.png"
      , e = "";
        ...
        sendMessages([{
            ...
            contents: {
                ...
                hero: {
                    ...
                    action: {
                        type: "uri",
                        uri: "line://app/2007045001-MY3PZ3Xk?auto=yes&type=image&downloadUrl=" + d + "&previewUrl=" + d
                    }
                },
                body: {
                    type: "box",
                ...
                footer: {
                    ...
                    contents: [{
                        ...
                        action: {
                            type: "uri",
                            label: "Profile",
                            uri: "line://app/2007045001-MY3PZ3Xk?auto=yes&type=profile"
                        }
                    }, {
                        type: "spacer",
                        size: "sm"
